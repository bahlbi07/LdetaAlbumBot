...
TRANSLATIONS = {
    'ti': {
        ...
        'btn_continue': "ይቐጽል ➡️", # Added to bridge Welcome to Menu
...
'btn_continue': "Continue ➡️", # Added to bridge Welcome to Menu 
...
'om': {
        'welcome_text': (
            ...
            'btn_continue': "Itti fufa ➡️", # Added to bridge Baga gara Menu dhuftan
